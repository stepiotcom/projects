...
u8 MPU_Write_Len(u8 addr,u8 reg,u8 len,u8 *buf)
{
    ...
    i2c_error = HAL_I2C_Mem_Write(&hi2c1,MPU_ADDR<<1,reg,I2C_MEMADD_SIZE_8BIT,buf,len,10);
	return 0;	
} 
...
{ 
    i2c_error =  HAL_I2C_Mem_Read(&hi2c1, MPU_ADDR<<1,reg,I2C_MEMADD_SIZE_8BIT,buf, len,10);
	return 0;	
}
...
{ 
    ...
    i2c_error = HAL_I2C_Mem_Write(&hi2c1,MPU_ADDR<<1,reg,I2C_MEMADD_SIZE_8BIT,&tempdata,1,10);
	return 0;
}
...
{
	u8 res;
    i2c_error =  HAL_I2C_Mem_Read(&hi2c1, MPU_ADDR<<1,reg,1,&res, 1,10); 
	return res;		
}
