  ...
  if(USART2_RX_STA&0x8000)
	{
		...
		{	
			...
			{
				case 12: 
						number2 = (USART2_RX_BUF[11]-0x30);
				break;
				case 13: 
						number2 = ((USART2_RX_BUF[12]-0x30)+(USART2_RX_BUF[11]-0x30)*10);
				break;
				case 14: 
						number2 = ((USART2_RX_BUF[13]-0x30) + (USART2_RX_BUF[12]-0x30)*10+(USART2_RX_BUF[11]-0x30)*100);
				break;
				case 15: 
						number2 = ((USART2_RX_BUF[14]-0x30)+ (USART2_RX_BUF[13]-0x30)*10 + (USART2_RX_BUF[12]-0x30)*100+(USART2_RX_BUF[11]-0x30)*1000);
				break;
				default : break;
			}
		}
