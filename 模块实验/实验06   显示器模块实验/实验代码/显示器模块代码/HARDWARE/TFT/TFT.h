...
#define T_CS_L   	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_RESET);
#define T_CS_H   	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_SET);
...
void TFT_UI(void);											//计算器显示界面
void TFT_Computing(void);								//计算器处理函数
void Lcd_Init(void); 
