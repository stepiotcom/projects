...
void LCD_UI(void)
{
		LCD_ShowString(30,50,latitude); 		//latitude
		LCD_ShowNum(110,50,0,10);						//数据（初始化为0 在485数据处理函数中更新）
		Draw_Circle(200,50,2);						//单位
		LCD_ShowString(190,53,fill); 			//填充	
	
		LCD_ShowString(30,100,longitude); 		//longitude
		LCD_ShowNum(110,100,0,10);					//数据（初始化为0 在485数据处理函数中更新）
		Draw_Circle(200,100,2);						//单位
		LCD_ShowString(191,103,fill); 		//填充	
